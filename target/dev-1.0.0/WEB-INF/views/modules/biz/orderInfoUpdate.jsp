...
<body>
		...
		<table class="table table-striped table-condensed " style="width:600px;margin-top:20px;" >
			...
			<tbody>
		   	...
		   	<tr>
				...
				<td><span class="uneditable-input" style="color:red;" id="pre_count_price">0.00元</span></td>
		   	</tr>
		   		<tr>
	...
	<ul class="nav nav-tabs">
		...
		<li class="active"><a href="${ctx}/biz/orderInfo/updateOrder?orderid=${orderInfo.orderId}">修改订单</a></li>
	</ul> <br>
	<div class="alert alert-success" style="margin-left:20px;margin-right:20px;">
              <button type="button" class="close" data-dismiss="alert">×</button>
          	   提示：只能减少订单订票数量、修改取票人手机/身份证号码，其它操作请重新下单
    </div>
   
	<form:form id="inputForm" modelAttribute="orderInfo" action="${ctx}/biz/orderInfo/updateOrder" method="post"  class="form-horizontal">
