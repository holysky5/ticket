	...
	<div id="main">
	           ...
	           <ul class="nav pull-right">
			  	 ...
			  	 <li class="dropdown">
				    ...
				    <ul class="dropdown-menu">
				      ...
				      <li><a href="${ctx}/sys/menu/tree?parentId=166" target="menuFrame"><i class="icon-user"></i>&nbsp; 直通订票</a></li>
				      </c:if>
				    </ul>
			  	 </li>
	    ...
	    <div class="container-fluid">
		   ...
		   <div id="footer" class="row-fluid">
	            Copyright &copy; 2012-${fns:getConfig('copyrightYear')} ${fns:getConfig('company.name')}&nbsp;   ${fns:getConfig('icp')} &nbsp;
