...
public class BaseDaoTest extends SpringTransactionalContextTests {
	...
	@Resource
	private RechargeConfirmDao rechargeConfirmDao;


	@Test
	public void testUpdateRC() throws Exception {
		RechargeConfirm rc = rechargeConfirmDao.findOne(1L);
		rechargeConfirmDao.updateForConfirm(rc.getId());
	...
	@Test
	public void testGenPass() throws Exception {
		String pass = SystemService.entryptPassword("admin");
