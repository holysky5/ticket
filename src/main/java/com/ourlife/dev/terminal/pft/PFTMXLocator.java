...
public class PFTMXLocator extends org.apache.axis.client.Service implements
		PFTMX {
	...
	public PFTMXLocator(java.lang.String wsdlLoc,
	...
	private java.lang.String PFTMXPort_address = Global
			.getConfig("pft_address");
	...
	@Override
	public PFTMXPort getPFTMXPort(java.net.URL portAddress)
			throws javax.xml.rpc.ServiceException {
		try {
	...
	public java.rmi.Remote getPort(Class serviceEndpointInterface)
		...
		try {
			if (PFTMXPort.class.isAssignableFrom(serviceEndpointInterface)) {
				PFTMXBindingStub _stub = new PFTMXBindingStub(new java.net.URL(
						PFTMXPort_address), this);
				_stub.setPortName(getPFTMXPortWSDDServiceName());
				return _stub;
			}
